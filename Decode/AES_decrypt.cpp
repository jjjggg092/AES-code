#define text_length 500      // could 80,000 or whatever
#define rows 4
#define cols 4
#define rounds 1
...
//   Globals
    char plaintext[text_length];  // vector de caracteres
    char auxtext[text_length];
    char ciphertext[text_length];
    char deciphertext[text_length];
    char dummy[1];
    char password[80];
    char password2[80];
    int  key;
    ...
    int password_lenght;
    unsigned char saved_password[10][rows][cols];
    int round=9;
...
int main()
{
    ...
    int j;
    FILE *in_file;
    if ((in_file = fopen ("texto_ciph.txt", "rt")) == NULL)
